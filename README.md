## behaviortree_cpp_v4 (rolling) - 4.10.0-2

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Mon, 31 Aug 2026 08:00:38 -0000`
...
## behaviortree_cpp_v4 (kilted) - 4.10.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted behaviortree_cpp_v4 -y` on `Mon, 31 Aug 2026 07:59:24 -0000`
...
## behaviortree_cpp_v4 (jazzy) - 4.10.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy behaviortree_cpp_v4 -y` on `Mon, 31 Aug 2026 07:57:57 -0000`
...
## behaviortree_cpp_v4 (humble) - 4.10.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble behaviortree_cpp_v4 -y` on `Mon, 31 Aug 2026 07:52:24 -0000`
...
## behaviortree_cpp_v4 (lyrical) - 4.10.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical behaviortree_cpp_v4 -y` on `Fri, 24 Jul 2026 06:59:04 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.10.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Fri, 24 Jul 2026 06:57:13 -0000`
...
## behaviortree_cpp_v4 (kilted) - 4.9.1-1

The packages in the `behaviortree_cpp_v4` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted behaviortree_cpp_v4 -y` on `Mon, 06 Jul 2026 20:16:46 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.9.1-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Mon, 06 Jul 2026 20:06:15 -0000`
...
## behaviortree_cpp_v4 (humble) - 4.9.1-1

The packages in the `behaviortree_cpp_v4` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble behaviortree_cpp_v4 -y` on `Mon, 06 Jul 2026 19:58:57 -0000`
...
## behaviortree_cpp_v4 (jazzy) - 4.9.1-1

The packages in the `behaviortree_cpp_v4` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy behaviortree_cpp_v4 -y` on `Mon, 06 Jul 2026 19:52:09 -0000`
...
## behaviortree_cpp_v4 (lyrical) - 4.9.1-1

The packages in the `behaviortree_cpp_v4` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical behaviortree_cpp_v4 -y` on `Mon, 06 Jul 2026 19:45:42 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.9.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Wed, 11 Feb 2026 09:55:07 -0000`
...
## behaviortree_cpp_v4 (kilted) - 4.9.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted behaviortree_cpp_v4 -y` on `Wed, 11 Feb 2026 09:28:35 -0000`
...
## behaviortree_cpp_v4 (jazzy) - 4.9.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy behaviortree_cpp_v4 -y` on `Wed, 11 Feb 2026 09:25:03 -0000`
...
## behaviortree_cpp_v4 (humble) - 4.9.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble behaviortree_cpp_v4 -y` on `Wed, 11 Feb 2026 09:16:56 -0000`
...
## behaviortree_cpp_v4 (kilted) - 4.8.3-1

The packages in the `behaviortree_cpp_v4` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted behaviortree_cpp_v4 -y` on `Tue, 30 Dec 2025 10:52:06 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.8.3-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Tue, 30 Dec 2025 10:46:59 -0000`
...
## behaviortree_cpp_v4 (jazzy) - 4.8.3-1

The packages in the `behaviortree_cpp_v4` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy behaviortree_cpp_v4 -y` on `Tue, 30 Dec 2025 10:39:51 -0000`
...
## behaviortree_cpp_v4 (humble) - 4.8.3-1

The packages in the `behaviortree_cpp_v4` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble behaviortree_cpp_v4 -y` on `Tue, 30 Dec 2025 10:32:28 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.8.2-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Thu, 30 Oct 2025 05:41:23 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.8.0-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Tue, 14 Oct 2025 18:51:28 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.7.2-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 --edit` on `Thu, 29 May 2025 10:33:20 -0000`
...
## behaviortree_cpp_v4 (rolling) - 4.7.1-1

The packages in the `behaviortree_cpp_v4` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v4 -y` on `Tue, 13 May 2025 17:39:12 -0000`
...
## behaviortree_cpp_v4 (jazzy) - 4.7.1-1
